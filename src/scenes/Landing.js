  ...
  return (
    ...
    >
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32 text-center md:text-start">
        ...
        >
          <p className="text-3xl md:text-5xl font-playfair z-10 ">
            Kanwar {""}
            <span
              className=" border-collapse xs:relative sm:text-blue">
          ...
          <div className="flex justify-center mt-6  md:mt-10"><TextAnimate/></div> 
          <p className="mt-6 mb-7 text-md text-center md:text-start">
